...
The contributor and AI-agent guide lives in **[AGENTS.md](AGENTS.md)** — start there. It covers repo layout, setup, prerequisites, all platform functions, coding rules, build commands, and what not to touch.
